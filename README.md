...
## Implement Details
* We need to use a function <img src='https://render.githubusercontent.com/render/math?math=Y=W \times X + B#gh-light-mode-only'> to fit Features(x_data) and Target(y_data)
