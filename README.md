...
* <img src="https://latex.codecogs.com/svg.image?\text{how&space;are&space;you&space;$&space;L&space;=&space;\sum\limits_{i=1}^{n}(y_i-\hat{y}_i)^2&space;=&space;\sum\limits_{i=1}^{n}(y_i-(wx&plus;b))^2&space;$}">
