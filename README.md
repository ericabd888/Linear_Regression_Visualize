...
* Gradient: Calculate partial differential of Loss Fucntion
    * Let <img alt="Image alt text" title="Optional image title" src="https://latex.codecogs.com/svg.image?L&space;=&space;\sum\limits_{i=1}^{n}(y_i-\hat{y}_i)^2&space;=&space;\sum\limits_{i=1}^{n}(y_i-(wx&plus;b))^2"/>
